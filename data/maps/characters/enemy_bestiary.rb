...
class Bestiary 
    ...
    def enemy(enemyName) 
        ...
        when "ghost"
            ...
            ghost.weapon = Weapon.new("GhostTouch",8,"blunt")
            ghost.totalArmor = 12
            ghost.mRes = 10
        ...
        when "goblin"
            ...
            goblin.weapon = Weapon.new("Rusty Sword",6,"slash")
            goblin.totalArmor = 8
